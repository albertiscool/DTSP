...
def dubins_path_length(s_x, s_y, s_yaw, g_x, g_y, g_yaw, curvature,
    ...
    lengths = _dubins_path_length_from_origin(
...
def _dubins_path_length_from_origin(end_x, end_y, end_yaw, curvature,
    ...
    dubins_path_length = sum(lengths)
...
def main():
    ...
    d_length = dubins_path_length(start_x, start_y, start_yaw, end_x, end_y, end_yaw, curvature)

    print("Dubins path length:", d_length)

    import timeit
    print(timeit.timeit("dubins_path_length(1.0,1.0,0,-3,-3,2,1.5)", number=1000, globals=globals()))
