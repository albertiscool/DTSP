...
from policy_GIN_GLKH import Policy_GIN_GLKH as Policy_GIN_GLKH, Policy_GIN_GLKH_ORIGIN, action_sample as action_sample_gin
...
base_seeds = [42, 123, 456, 789, 999, 2024, 31415, 271828, 161803, 123456,
              ...
              13579, 24680, 11223, 44556, 77889, 10101, 20202, 30303, 40404, 50505, 60606] # 30 unique seeds
n_agent = 3
...
for case_name, turning_radius in database.items():
...
print(f"Total instances in database: {len(database)}")
...
summary_data = {}
for case_name in database.keys():
    case_results = all_results[case_name]
...
print("- {case_name}_comprehensive_comparison.png: Comprehensive metrics comparison")
print("- {case_name}_best_solutions_comparison.png: Best solutions visualization")
