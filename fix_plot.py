...
class Version4_TransformerAndSA(Version3_TangentSmoothing):
    ...
    def solve(self, centers, start_node_idx, max_iter=800, cooling_rate=0.996):
        n = len(centers)
        ...
        temp = 200.0
        # SA 微調 (只做 1000 次，發揮 Transformer 速度優勢)
        max_iter = 1000
        for step in range(max_iter):
            t_curr = temp * (cooling_rate ** step)
            new_idx = list(indices)
...
def run_benchmark():
    ...
    draw_single_panel(axes_0[3], static_centers, v4_idx_0, v4_pts_0, start_node_idx, 
                      "Version 4: Transformer + SA", f"Length: {v4_len_0:.2f} km  |  Collisions: {v4_col_0}", cost_calc)
    ...
    draw_single_panel(axes_5[3], v4_centers, v4_idx_5, v4_pts_5, start_node_idx, 
                      "Version 4: Transformer + SA", f"Length: {v4_len_5:.2f} km  |  Collisions: {v4_col_5}", cost_calc)
    ...
    # 航程對比
    stage0_lens = [v1_len_0, v2_len_0, v3_len_0, v4_len_0]
    stage5_lens = [v1_len_5, v2_len_5, v3_len_5, v4_len_5]
    ...
    # 碰撞次數對比
    stage0_cols = [v1_col_0, v2_col_0, v3_col_0, v4_col_0]
    stage5_cols = [v1_col_5, v2_col_5, v3_col_5, v4_col_5]
